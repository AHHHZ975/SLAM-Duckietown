...
distortion_coeff = np.array(camera_list["distortion_coefficients"]["data"]).reshape(
    5, 1
)

images_data_dir = (
    "/home/asha/SLAMDuck/luthor-2019-11-23-19-29-02/luthor_2019-11-23-19-29-02_images/"
)
...
newmatrix, roi = cv2.getOptimalNewCameraMatrix(
    camera_intrinsic_matrix, distortion_coeff, (width, height), 1, (width, height)
)
