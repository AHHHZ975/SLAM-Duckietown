...
velocities = np.loadtxt(
    "/home/asha/SLAMDuck/data_dec_02/velocity_time_luthor_2019-12-02-18-53-07/interpolated_wheel_velocities.txt"
)
time = np.loadtxt(
    "/home/asha/SLAMDuck/data_dec_02/velocity_time_luthor_2019-12-02-18-53-07/interpolated_time.txt"
)
range_bearing_dir = (
    "/home/asha/SLAMDuck/data_dec_02/range_bearing_luthor_2019-12-02-18-53-07/"
)
        ...
        for j in range(landmarks.shape[0]):
            if landmarks[j][0] in landmark_names:
                ...
                if int(landmarks[j][0]) in previously_observed_landmarks:
                    ...
                    beta = (
                        X_check_k[landmark_index] - X_check_k[0] - d * cos(X_check_k[2])
                    )
...
for i in range(0, len(ellipse_height), 50):
    ...
    ell = Ellipse(
        xy=(x[i], y[i]),
        width=ellipse_width[i],
        height=ellipse_height[i],
        angle=ellipse_angle[i],
        color="red",
    )
